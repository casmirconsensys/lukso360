...
const Signup = () => {
    ...
    const updateUserData = async () => {
      try {
        ...
        if (data === false) {
          ...
          const query = new Moralis.Query(UserClass).equalTo(
            "username",
            uMoralisUsername
          );
  ...
  const createAccount = async () => {
    if (fullname) {
      ...
      } else setValidationError("Please enter your username");
    } else setValidationError("Please enter your full name");
  };
  ...
  return (
    <Layout backgroundImage="signup">
      <div className="row">
        <LAccountsCol
          logo="../images/accounts/360sUp.svg"
          image="../images/accounts/sign-up-banner.jpg"
          alt=""
        />
        <RAccountsCol>
          <>
            ...
            >
              ...
              <br />
              FOR
              <span className={`color-accent-orange ${fonts.gilroy}`}>
                {" "}
                360{" "}
              </span>
              NFT
