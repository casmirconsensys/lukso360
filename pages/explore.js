...
const Explore = () => {
  ...
  const handleSearch = (event) => {
    if (feedData) {
      ...
      let toFilter;
      filterValue != "All"
        ? (toFilter = feedData.filter((feed) => feed.feedType === filterValue))
        : (toFilter = feedData);
        ...
        <div className={`${styles.containerGrid} ${fonts.mont}`}>
          ...
          <div className={styles.bottomRight}>
            <div className={styles.subHeader}>
              Top token in
              <button
                className={`btn btn-secondary dropdown-toggle ${styles.dropdownToggle}`}
                type="button"
                id="dropdownMenu2"
            ...
            <ul className={styles.tokenSection}>
              <li className={styles.tokenItem}>
                <img
                  src="https://ipfs.io/ipfs/QmdusuNQxHyBn2vnhRpvDwrfbxzz9Z1DdkNyBgYUXXDVBT"
              ...
              <li className={styles.tokenItem}>
                <img
                  src="https://ipfs.io/ipfs/QmedGWqsuS1bAyye5V7m41TJH6SYbbWH3brpHGzC1J6C6z"
                  className="token-image"
                />
              ...
              <li className={styles.tokenItem}>
                <img
                  src="https://ipfs.io/ipfs/QmPSRpzv5151rkpUqi1iiqTE9frWKA9SrWNWNBZNik21DG"
                  className="token-image"
                />
